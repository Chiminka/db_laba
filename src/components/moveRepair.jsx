  ...
  return (
    <div className="w-full flex">
      <form className='flex w-1/3 p-5 flex-col' onSubmit={handleSubmit}>
        ...
        <button type='submit' className='m-5 p-2 bg-[#779cc1] rounded-md text-lg font-semibold hover:bg-[#3c556e] transition ease-in delay-150'>Передати</button>
      </form>
      {
        result &&
        <div className="w-2/3 flex p-5 justify-center items-center">
          {result?.message === 'Ремонт репліковано' ? <p className='text-green-500 font-semibold text-2xl text-center'>Передано успішно</p> : <p className='text-rose-600 font-semibold text-2xl text-center'>Ремонт вже було передано</p>}
        </div>
      }
